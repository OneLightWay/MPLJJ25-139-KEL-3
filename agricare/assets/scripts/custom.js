...
$(function() {
	...
	function init_template(){
        ...
        function setColorScheme() {
            ...
            if(isDarkMode) activateLightMode();
...
//            var share_title = document.title;
    ...
    $(function(){
		'use strict';
        // var loadJSPage = function(url){
        //     var scriptTag = document.createElement('script');
        //     scriptTag.src = url;
        //     scriptTag.id  = 'generatedJavascriptPage';
		...
		var options = {
			...
			onStart: {
				...
				$container.addClass('is-exiting');// Add your CSS animation reversing class
                    ...
                    // $('#generatedJavascriptPage').remove()
					return false;
				}
			},
			onReady: {
