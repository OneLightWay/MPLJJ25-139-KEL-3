    ...
    setTimeout(function () {
        ...
        setTimeout(function () {
            if (HELPER.getItem('from_page')) {
                ...
                if (HELPER.getItem('from_page') == "detail-kios-nearby") {
                    setTimeout(function () {
                        $('.div-button').hide()
                    }, 300)
                }
            ...
            if (res.total > 0) {
                ...
                $.each(res.data, function (i, v) {
                    ...
                    produk += ` <div class="one-half">
                                ...
                                <a href="javascript:;" class="color-theme caption m-0" style="height:200px; width:100%;" onclick="detailProductPupuk('`+ v.kios_pupuk_id + `')">
                                    <div class="caption bottom-10">
                                      <div class="caption-overlay bg-gradient opacity-10"></div>
                                        <img src="`+ img + `" class="centerimg detail-kios_pupuk_image" style="height:100px;">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="left-15 bottom-0 font-12 lh-20"><i class="${icon_harga} color-highlight"></i>Harga : Rp. ` + HELPER.toRp(v.kios_pupuk_harga) + `</label>
                                        <label class="left-10 bottom-0 font-12 lh-20"><i class="${icon_stok} color-highlight" style="padding-right: 4px;"></i>Stok : ` + v.kios_pupuk_stok + ` Pack</label>
                                    </div>
                               </a>  
                               </div> 
                            </div>`;
...
function detailProductPupuk(id) {
    ...
    HELPER.setItem('from_page', 'produk-pupuk-more')
