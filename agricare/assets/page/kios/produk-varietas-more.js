            ...
            if (res.total > 0) {
                ...
                $.each(res.data, function (i, v) {
                    ...
                    produk += ` <div class="one-half">
                                ...
                                <a href="javascript:;" class="color-theme caption m-0" style="height:200px; width:100%;" onclick="detailProductBenih('`+ v.kios_varietas_id + `')">
                                    <div class="caption bottom-0">
                                      <div class="caption-overlay bg-gradient opacity-10"></div>
                                        <img src="`+ img + `" class="centerimg detail-kios_varietas_image" style="height:100px;">
                                    </div>
                                    <div>
                                        <h5 class="custom-card-header-full bottom-0 lh-20 font-12 center-text color-white" style="background-color: ${color}">` + v.kios_varietas_nama + `</h5>
                                    </div>    
                                    <h5 class="bottom-0 lh-20 font-12 center-text top-25 bold">`+ v.kios_varietas_kemasan + ` Kg</h5>
                                    <div>
                                        <label class="left-15 bottom-0 font-12 lh-20"><i class="${icon_harga} color-highlight"></i>Harga : Rp. ` + HELPER.toRp(v.kios_varietas_harga) + `</label>
...
function detailProductBenih(id) {
    ...
    HELPER.setItem('from_page', 'produk-varietas-more')
