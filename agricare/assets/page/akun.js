...
function loadAkun() {
	...
	$('.user-poin').text(HELPER.getItem('user_total_poin'))
...
function onVoucher() {
	HELPER.setItem('from_page', 'akun')
	onPage('voucher')
}

function downloadPanduan() {
	var url = BASE_ASSETS + 'manbook/petani.pdf';
	window.location.href = url
}

function downloadGuideDokter() {
    var url = BASE_ASSETS + "manbook/dokter-nk-for-petani.pdf";
    window.location.href = url;
}
