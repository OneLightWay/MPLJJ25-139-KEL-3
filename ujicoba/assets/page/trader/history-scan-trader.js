...
//         $(".total_scan_box").text(HELPER.convertK(res.data.totalScanBox));
//       }
//     },
//   });
// }
...
function traderCekSampling(text = null, batch_no = null, pouch_no = null) {
  HELPER.block();
  HELPER.ajax({
